...
@NoArgsConstructor
@AllArgsConstructor
@NamedQuery(name = Technologic.GET_ALL_TECHNOLOGIC, query = "select objet from Technologic objet")
...
public abstract class Technologic extends Material {
    ...
    public static final String GET_ALL_TECHNOLOGIC = "Technologic.findAll";
